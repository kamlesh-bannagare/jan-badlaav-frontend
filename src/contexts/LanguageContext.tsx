...
const translations: Record<Language, Record<string, string>> = {
  mr: {
    ...
    privacyLastUpdated: 'शेवटचे अपडेट: जानेवारी 2025',
    privacyIntro: 'परिचय',
    privacyIntroText: 'जनता बदलाव ("आम्ही," "आमचा," किंवा "आमच्या") तुमची गोपनीयता संरक्षित करण्यासाठी वचनबद्ध आहे. हे गोपनीयता धोरण स्पष्ट करते की जेव्हा तुम्ही आमची वेबसाइट भेट द्याल किंवा आमच्या राजकीय चळवळीत सहभागी व्हाल तेव्हा आम्ही तुमची माहिती कशी गोळा करतो, वापरतो, उघड करतो आणि सुरक्षित ठेवतो.',
    privacyInfoCollect: 'आम्ही गोळा करत असलेली माहिती',
    privacyInfoCollectText: 'आम्ही खालील प्रकारची माहिती गोळा करू शकतो:',
    privacyInfoItem1: 'वैयक्तिक ओळख माहिती (नाव, ईमेल पत्ता, फोन नंबर)',
    privacyInfoItem2: 'लोकसंख्याशास्त्रीय माहिती (शहर, राज्य, प्रदेश)',
    privacyInfoItem3: 'स्वयंसेवक आणि सदस्यत्व माहिती',
    privacyInfoItem4: 'संवाद प्राधान्ये',
    privacyUseInfo: 'आम्ही तुमची माहिती कशी वापरतो',
    privacyUseInfoText: 'आम्ही गोळा केलेली माहिती यासाठी वापरतो:',
    privacyUseItem1: 'सदस्यत्व अर्ज प्रक्रिया करणे',
    privacyUseItem2: 'कार्यक्रम, मोहिम आणि उपक्रमांबद्दल संवाद साधणे',
    privacyUseItem3: 'आमच्या सेवा आणि वेबसाइट सुधारणे',
    privacyUseItem4: 'कायदेशीर जबाबदाऱ्यांचे पालन करणे',
    privacyDataSecurity: 'डेटा सुरक्षा',
    privacyDataSecurityText: 'आम्ही अनधिकृत प्रवेश, बदल, प्रकटीकरण किंवा नाशापासून तुमची वैयक्तिक माहिती संरक्षित करण्यासाठी योग्य तांत्रिक आणि संघटनात्मक उपाय लागू करतो.',
    privacyRights: 'तुमचे अधिकार',
    privacyRightsText: 'तुम्हाला याचा अधिकार आहे:',
    privacyRightItem1: 'तुमची वैयक्तिक माहिती पहाणे',
    privacyRightItem2: 'चुकीचा डेटा दुरुस्त करणे',
    privacyRightItem3: 'तुमचा डेटा हटवण्याची विनंती करणे',
    privacyRightItem4: 'संवादांमधून बाहेर पडणे',
    privacyContact: 'आमच्याशी संपर्क साधा',
    privacyContactText: 'या गोपनीयता धोरणाबद्दल प्रश्न असल्यास, कृपया आमच्याशी contact@jantabadlaav.org वर संपर्क साधा',

    // Terms & Conditions Page
    termsConditionsTitle: 'अटी व शर्ती',
    termsLastUpdated: 'शेवटचे अपडेट: जानेवारी 2025',
    termsAcceptance: 'अटींची स्वीकृती',
    termsAcceptanceText: 'जनता बदलाव वेबसाइट आणि सेवा ऍक्सेस आणि वापरून, तुम्ही या करारातील अटी आणि तरतुदींना बांधील असणे स्वीकारता.',
    termsMembership: 'सदस्यत्व',
    termsMembershipText: 'जनता बदलावमधील सदस्यत्व मंजुरीच्या अधीन आहे. सर्व सदस्यांनी:',
    termsMemberItem1: 'अचूक आणि संपूर्ण माहिती प्रदान करणे',
    termsMemberItem2: 'आमच्या आचारसंहितेचे पालन करणे',
    termsMemberItem3: 'चळवळीच्या तत्त्वे आणि मूल्यांना समर्थन देणे',
    termsMemberItem4: 'सद्भावनेने सहभागी होणे',
    termsConduct: 'वापरकर्त्याचे वर्तन',
    termsConductText: 'वापरकर्ते यास सहमत आहेत:',
    termsConductItem1: 'कोणत्याही लागू कायदे किंवा नियमांचे उल्लंघन न करणे',
    termsConductItem2: 'फसव्या किंवा फसव्या पद्धतींमध्ये गुंतणे नाही',
    termsConductItem3: 'इतरांना त्रास देणे, गैरवर्तन करणे किंवा हानी पोहोचवणे नाही',
    termsConductItem4: 'स्पॅम किंवा न मागितलेले संवाद वितरित न करणे',
    termsIP: 'बौद्धिक संपदा',
    termsIPText: 'या वेबसाइटवरील सर्व सामग्री, लोगो, प्रतिमा आणि मजकूरासह, जनता बदलावची मालमत्ता आहे आणि कॉपीराइट आणि इतर बौद्धिक संपदा कायद्यांद्वारे संरक्षित आहे.',
    termsLiability: 'दायित्वाची मर्यादा',
    termsLiabilityText: 'जनता बदलाव तुमच्या सेवांच्या वापरामुळे किंवा अक्षमतेमुळे होणाऱ्या कोणत्याही अप्रत्यक्ष, आनुषंगिक, विशेष, परिणामी किंवा दंडात्मक नुकसानीसाठी जबाबदार राहणार नाही.',
    termsModifications: 'सुधारणा',
    termsModificationsText: 'आम्ही या अटी कोणत्याही वेळी सुधारण्याचा अधिकार राखून ठेवतो. बदलांनंतर आमच्या सेवांचा सतत वापर केल्याने सुधारित अटींची स्वीकृती होते.',
    termsContactInfo: 'संपर्क माहिती',
    termsContactInfoText: 'या अटी व शर्तींबद्दल प्रश्नांसाठी, कृपया आमच्याशी contact@jantabadlaav.org वर संपर्क साधा',
  ...
  en: {
    ...
    privacyIntroText: 'Janta Badlaav ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or engage with our political movement.',
    privacyInfoCollect: 'Information We Collect',
    privacyInfoCollectText: 'We may collect the following types of information:',
    privacyInfoItem1: 'Personal identification information (name, email address, phone number)',
    privacyInfoItem2: 'Demographic information (city, state, region)',
    privacyInfoItem3: 'Volunteer and membership information',
    privacyInfoItem4: 'Communication preferences',
    privacyUseInfo: 'How We Use Your Information',
    privacyUseInfoText: 'We use the information we collect to:',
    privacyUseItem1: 'Process membership applications',
    privacyUseItem2: 'Communicate about events, campaigns, and initiatives',
    privacyUseItem3: 'Improve our services and website',
    privacyUseItem4: 'Comply with legal obligations',
    privacyDataSecurity: 'Data Security',
    privacyDataSecurityText: 'We implement appropriate technical and organizational measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.',
    privacyRights: 'Your Rights',
    privacyRightsText: 'You have the right to:',
    privacyRightItem1: 'Access your personal information',
    privacyRightItem2: 'Correct inaccurate data',
    privacyRightItem3: 'Request deletion of your data',
    privacyRightItem4: 'Opt-out of communications',
    privacyContact: 'Contact Us',
    privacyContactText: 'If you have questions about this Privacy Policy, please contact us at contact@jantabadlaav.org',

    // Terms & Conditions Page
    termsConditionsTitle: 'Terms & Conditions',
    termsLastUpdated: 'Last updated: January 2025',
    termsAcceptance: 'Acceptance of Terms',
    termsAcceptanceText: 'By accessing and using the Janta Badlaav website and services, you accept and agree to be bound by the terms and provision of this agreement.',
    termsMembership: 'Membership',
    termsMembershipText: 'Membership in Janta Badlaav is subject to approval. All members must:',
    termsMemberItem1: 'Provide accurate and complete information',
    termsMemberItem2: 'Adhere to our code of conduct',
    termsMemberItem3: 'Support the principles and values of the movement',
    termsMemberItem4: 'Participate in good faith',
    termsConduct: 'User Conduct',
    termsConductText: 'Users agree not to:',
    termsConductItem1: 'Violate any applicable laws or regulations',
    termsConductItem2: 'Engage in fraudulent or deceptive practices',
    termsConductItem3: 'Harass, abuse, or harm others',
    termsConductItem4: 'Distribute spam or unsolicited communications',
    termsIP: 'Intellectual Property',
    termsIPText: 'All content on this website, including logos, images, and text, is the property of Janta Badlaav and is protected by copyright and other intellectual property laws.',
    termsLiability: 'Limitation of Liability',
    termsLiabilityText: 'Janta Badlaav shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use our services.',
    termsModifications: 'Modifications',
    termsModificationsText: 'We reserve the right to modify these terms at any time. Continued use of our services after changes constitutes acceptance of the modified terms.',
    termsContactInfo: 'Contact Information',
    termsContactInfoText: 'For questions about these Terms and Conditions, please contact us at contact@jantabadlaav.org',
  ...
  hi: {
    ...
    privacyLastUpdated: 'अंतिम अपडेट: जनवरी 2025',
    privacyIntro: 'परिचय',
    privacyIntroText: 'जनता बदलाव ("हम," "हमारा," या "हमारे") आपकी गोपनीयता की रक्षा के लिए प्रतिबद्ध है। यह गोपनीयता नीति बताती है कि जब आप हमारी वेबसाइट पर जाते हैं या हमारे राजनीतिक आंदोलन में शामिल होते हैं तो हम आपकी जानकारी कैसे एकत्र करते हैं, उपयोग करते हैं, प्रकट करते हैं और सुरक्षित रखते हैं।',
    privacyInfoCollect: 'हम जो जानकारी एकत्र करते हैं',
    privacyInfoCollectText: 'हम निम्नलिखित प्रकार की जानकारी एकत्र कर सकते हैं:',
    privacyInfoItem1: 'व्यक्तिगत पहचान जानकारी (नाम, ईमेल पता, फोन नंबर)',
    privacyInfoItem2: 'जनसांख्यिकीय जानकारी (शहर, राज्य, क्षेत्र)',
    privacyInfoItem3: 'स्वयंसेवक और सदस्यता जानकारी',
    privacyInfoItem4: 'संचार प्राथमिकताएं',
    privacyUseInfo: 'हम आपकी जानकारी का उपयोग कैसे करते हैं',
    privacyUseInfoText: 'हम एकत्र की गई जानकारी का उपयोग करते हैं:',
    privacyUseItem1: 'सदस्यता आवेदन संसाधित करने के लिए',
    privacyUseItem2: 'कार्यक्रमों, अभियानों और पहलों के बारे में संवाद करने के लिए',
    privacyUseItem3: 'हमारी सेवाओं और वेबसाइट में सुधार के लिए',
    privacyUseItem4: 'कानूनी दायित्वों का पालन करने के लिए',
    privacyDataSecurity: 'डेटा सुरक्षा',
    privacyDataSecurityText: 'हम अनधिकृत पहुंच, परिवर्तन, प्रकटीकरण या विनाश से आपकी व्यक्तिगत जानकारी की सुरक्षा के लिए उपयुक्त तकनीकी और संगठनात्मक उपाय लागू करते हैं।',
    privacyRights: 'आपके अधिकार',
    privacyRightsText: 'आपको अधिकार है:',
    privacyRightItem1: 'अपनी व्यक्तिगत जानकारी तक पहुंचने का',
    privacyRightItem2: 'गलत डेटा को सही करने का',
    privacyRightItem3: 'अपने डेटा को हटाने का अनुरोध करने का',
    privacyRightItem4: 'संचार से बाहर निकलने का',
    privacyContact: 'हमसे संपर्क करें',
    privacyContactText: 'यदि इस गोपनीयता नीति के बारे में कोई प्रश्न हैं, तो कृपया हमसे contact@jantabadlaav.org पर संपर्क करें',

    // Terms & Conditions Page
    termsConditionsTitle: 'नियम और शर्तें',
    termsLastUpdated: 'अंतिम अपडेट: जनवरी 2025',
    termsAcceptance: 'शर्तों की स्वीकृति',
    termsAcceptanceText: 'जनता बदलाव वेबसाइट और सेवाओं तक पहुंच और उपयोग करके, आप इस समझौते की शर्तों और प्रावधानों से बंधे रहने के लिए सहमत होते हैं।',
    termsMembership: 'सदस्यता',
    termsMembershipText: 'जनता बदलाव में सदस्यता स्वीकृति के अधीन है। सभी सदस्यों को चाहिए:',
    termsMemberItem1: 'सटीक और पूर्ण जानकारी प्रदान करें',
    termsMemberItem2: 'हमारे आचार संहिता का पालन करें',
    termsMemberItem3: 'आंदोलन के सिद्धांतों और मूल्यों का समर्थन करें',
    termsMemberItem4: 'सद्भावना से भाग लें',
    termsConduct: 'उपयोगकर्ता आचरण',
    termsConductText: 'उपयोगकर्ता सहमत हैं कि नहीं करेंगे:',
    termsConductItem1: 'किसी भी लागू कानून या विनियम का उल्लंघन',
    termsConductItem2: 'धोखाधड़ी या भ्रामक प्रथाओं में संलग्न होना',
    termsConductItem3: 'दूसरों को परेशान करना, दुर्व्यवहार करना या नुकसान पहुंचाना',
    termsConductItem4: 'स्पैम या अवांछित संचार वितरित करना',
    termsIP: 'बौद्धिक संपदा',
    termsIPText: 'इस वेबसाइट पर सभी सामग्री, लोगो, छवियां और पाठ सहित, जनता बदलाव की संपत्ति है और कॉपीराइट और अन्य बौद्धिक संपदा कानूनों द्वारा संरक्षित है।',
    termsLiability: 'दायित्व की सीमा',
    termsLiabilityText: 'जनता बदलाव आपकी सेवाओं के उपयोग या अक्षमता से होने वाले किसी भी अप्रत्यक्ष, आकस्मिक, विशेष, परिणामी या दंडात्मक नुकसान के लिए उत्तरदायी नहीं होगा।',
    termsModifications: 'संशोधन',
    termsModificationsText: 'हम किसी भी समय इन शर्तों को संशोधित करने का अधिकार सुरक्षित रखते हैं। परिवर्तनों के बाद हमारी सेवाओं का निरंतर उपयोग संशोधित शर्तों की स्वीकृति का गठन करता है।',
    termsContactInfo: 'संपर्क जानकारी',
    termsContactInfoText: 'इन नियम और शर्तों के बारे में प्रश्नों के लिए, कृपया हमसे contact@jantabadlaav.org पर संपर्क करें',
